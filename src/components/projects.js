          ...
          <div className="m-3">
            <div className="flex">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                href="https://github.com/manishsharma8/Pocket-Url"
              >
                <StaticImage
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <div className="pt-1 px-3 rounded opacity-90 bg-gray-600 text-gray-200 font-bold align-middle">
                <StaticImage
                  className="w-4 h-4 mr-1 cursor-pointer"
              ...
              <div className="pt-1 px-3 rounded opacity-90 bg-purple-900 text-purple-200 font-bold align-middle">
                <StaticImage
                  className="w-4 h-4 mr-1 cursor-pointer"
              ...
              <div className="py-1 px-3 rounded opacity-90 bg-pink-900 text-pink-200 font-bold align-middle">
                <StaticImage
                  className="w-4 h-4 mr-1 cursor-pointer"
            ...
            <div className="mr-2 text-lg font-medium text-gray-400">
              A simple and easy URL Shortener. Create short urls with custom
              aliases and easily track your url visits.
            </div>
          </div>
        </div>
        <div className="rounded border-2 border-gray-900 text-sm row-span-3">
